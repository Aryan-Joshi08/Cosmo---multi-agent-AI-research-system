...
function OrbitLoader() {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 18, padding: "2rem 0" }}>
      ...
      <p style={{ color: "#94a3b8", fontSize: 13, letterSpacing: "0.08em", textTransform: "uppercase", fontFamily: "'DM Sans', sans-serif" }}>
        Agents working
      </p>
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: "1rem" }}>
        ...
        <h3 style={{ margin: 0, fontSize: 13, fontWeight: 600, color: "#c4b5fd", letterSpacing: "0.06em", textTransform: "uppercase", fontFamily: "'DM Sans', sans-serif" }}>
          {title}
        </h3>
      </div>
      {children}
...
function ScoreRing({ score }) {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: "1rem" }}>
      ...
      <div>
        <p style={{ margin: 0, fontSize: 13, color: "#64748b", fontFamily: "'DM Sans', sans-serif" }}>Critic Score</p>
        <p style={{ margin: 0, fontSize: 20, fontWeight: 700, color, fontFamily: "'Outfit', sans-serif" }}>{num}/10</p>
      </div>
    </div>
  );
}
...
export default function Cosmo() {
  ...
  return (
    <div style={{
      ...
      {/* ✅ FIX 1: Global reset to remove white side gaps */}
      <style>{`
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 860, margin: "0 auto", padding: "0 1.5rem 4rem" }}>
        ...
        {/* ✅ FIX 2: Navbar — "AI Research Navigator" text removed */}
        <nav style={{
        ...
        {phase === "idle" && (
          <div style={{ textAlign: "center", padding: "2rem 0 3rem" }}>
            ...
            <p style={{ color: "#64748b", fontSize: 16, maxWidth: 480, margin: "0 auto 2.5rem", lineHeight: 1.7, fontFamily: "'DM Sans', sans-serif" }}>
        ...
        {phase === "running" && (
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ color: "#475569", fontSize: 13, marginBottom: "1.5rem", fontFamily: "'DM Sans', sans-serif" }}>{currentStepDesc}</p>
        ...
        {phase === "error" && (
          <div style={{
            ...
            <h3 style={{ color: "#f472b6", fontFamily: "'Outfit', sans-serif", marginBottom: "0.5rem" }}>
              Mission aborted
            </h3>
            <p style={{ color: "#64748b", fontSize: 14, marginBottom: "1.5rem", fontFamily: "'DM Sans', sans-serif" }}>{error}</p>
        ...
        {/* ✅ FIX 3: Results — Search Results & Scraped Content cards removed */}
        {phase === "done" && results && (
          <div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1rem", flexWrap: "wrap", gap: 12 }}>
              <div>
                <p style={{ margin: 0, fontSize: 12, color: "#7c3aed", letterSpacing: "0.1em", textTransform: "uppercase", fontFamily: "'DM Sans', sans-serif" }}>Mission complete</p>
                <h2 style={{
            ...
            <GlassCard title="Research Report" icon="✍️" accentColor="#a78bfa" delay={0}>
              <div style={{
                color: "#cbd5e1", fontSize: 14, lineHeight: 1.8,
                whiteSpace: "pre-wrap", maxHeight: 400, overflowY: "auto",
                paddingRight: 8, fontFamily: "'DM Sans', sans-serif",
              }}>
            ...
            <div style={{ marginTop: 16 }}>
              <GlassCard title="Critic Review" icon="⭐" accentColor="#f472b6" delay={150}>
                {extractScore(results.feedback) && (
                  <ScoreRing score={extractScore(results.feedback)} />
                )}
                <p style={{ color: "#94a3b8", fontSize: 13, lineHeight: 1.7, margin: 0, whiteSpace: "pre-wrap", fontFamily: "'DM Sans', sans-serif" }}>
